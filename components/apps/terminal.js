...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["projects", "personal-documents", "skills", "languages", "education", "interests"],
            education: ["VCE-Mysore"],
            skills: ["Full-Stack Development", "Angular", "Bootstrap", "MySQL", "Oracle SQL", "Android Studio"],
            projects: ["canvas-air", "personal-portfolio-website"],
            interests: ["Software Engineering", "Computer Vision", "Web Development"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">srivatsa@Mysore</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/srivatsa")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-srivatsa, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-srivatsa":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-srivatsa");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-srivatsa, todoist, trash, settings, sendmsg ]";
                }
                break;
